			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									ABC Road<br>
									<a href="#">HO_Junction</a> 2445
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">majormyles@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									(233) 247466205
					...
					<ul class="copyright">
						<li>&copy; 2022 BookMyBusTicket. All rights reserved. Brought To You By <a href="#">Major Myles</a></li>
